...
window.addEventListener('scroll', () =>{
    ...
    if(offsetY < ($('.slider').height() /2) || (offsetY + windowHeight - $("footer").height()) >= footerOffsetTop)
    {
        // console.log(true)
...
window.addEventListener('scroll', () => {
   ...
   if(document.querySelector('html').scrollTop > (sliderHeight - header.offsetHeight + 1))
   {
...
imgList = [
    ...
    },
    {
        id: 2,
        content : "LVRoom",
        src : "http://cdn.home-designing.com/wp-content/uploads/2018/04/Taupe-sofa.jpg"
    },
    {
        id: 3,
        content : "bedroom2",
        src : "http://cdn.home-designing.com/wp-content/uploads/2016/09/dark-bedroom-inspiration.jpg"
    }
]
